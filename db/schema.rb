...
ActiveRecord::Schema.define(version: 2020_06_02_041049) do
  ...
  add_foreign_key "vote_answers", "users"
  add_foreign_key "vote_questions", "questions"
  add_foreign_key "vote_questions", "users"
end
